        ...
        <div className="absolute inset-0 z-10 flex flex-col h-full">
          ...
          <div className="p-6 md:p-8 flex items-end justify-between">
            ...
            <div className="flex-1 mr-4">
              ...
              <motion.h1 
                className={`${gameData.game_name == 'Street Fighter' ? 'text-xl' : 'text-3xl md:text-5xl'} ${GameFont(gameData.game_name)} text-white drop-shadow-lg bg-gradient-to-r from-white to-white/70 text-transparent bg-clip-text mb-3`}
                ...
                <div className="flex flex-wrap gap-4 text-white/80 text-xs">
                  ...
                  {tournament && tournament.registration_start && tournament.registration_end && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className='text-primary font-semibold'><span className='font-mono text-md text-white'>Registration:</span> {formatDate(tournament.registration_start)} - {formatDate(tournament.registration_end)}</span>
                    </div>
                  )}
